...
func TestUserMeUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Users.Me.Update(context.TODO(), jamesburvelocallaghaniiicitibankdemobusinessinc.UserMeUpdateParams{
		Address: jamesburvelocallaghaniiicitibankdemobusinessinc.F(jamesburvelocallaghaniiicitibankdemobusinessinc.AddressParam{
			City:    jamesburvelocallaghaniiicitibankdemobusinessinc.F("Quantumville"),
			Country: jamesburvelocallaghaniiicitibankdemobusinessinc.F("USA"),
			State:   jamesburvelocallaghaniiicitibankdemobusinessinc.F("CA"),
			Street:  jamesburvelocallaghaniiicitibankdemobusinessinc.F("100 Innovation Drive"),
			Zip:     jamesburvelocallaghaniiicitibankdemobusinessinc.F("90210"),
		}),
