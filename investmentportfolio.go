...
type InvestmentPortfolio struct {
	...
	Type                  InvestmentPortfolioType          `json:"type"`
...
func (r InvestmentPortfolioType) IsKnown() bool {
	switch r {
	case InvestmentPortfolioTypeEquities, InvestmentPortfolioTypeBonds, InvestmentPortfolioTypeDiversified, InvestmentPortfolioTypeCrypto:
		return true
	}
	return false
}
...
const (
	...
	InvestmentPortfolioRebalanceResponseStatusExecuting           InvestmentPortfolioRebalanceResponseStatus = "executing"
...
func (r InvestmentPortfolioRebalanceResponseStatus) IsKnown() bool {
	switch r {
	case InvestmentPortfolioRebalanceResponseStatusAnalyzing, InvestmentPortfolioRebalanceResponseStatusPendingConfirmation, InvestmentPortfolioRebalanceResponseStatusExecuting, InvestmentPortfolioRebalanceResponseStatusCompleted, InvestmentPortfolioRebalanceResponseStatusFailed:
		return true
	}
	return false
}
...
func (r InvestmentPortfolioNewParamsType) IsKnown() bool {
	switch r {
	case InvestmentPortfolioNewParamsTypeEquities, InvestmentPortfolioNewParamsTypeBonds, InvestmentPortfolioNewParamsTypeDiversified, InvestmentPortfolioNewParamsTypeCrypto:
		return true
	}
	return false
}
