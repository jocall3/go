...
type CorporateComplianceAuditGetReportResponse struct {
	...
	Status                 CorporateComplianceAuditGetReportResponseStatus        `json:"status"`
...
const (
	...
	CorporateComplianceAuditRequestParamsAuditScopeCorporateCards  CorporateComplianceAuditRequestParamsAuditScope = "corporate_cards"
	CorporateComplianceAuditRequestParamsAuditScopePayments        CorporateComplianceAuditRequestParamsAuditScope = "payments"
)

func (r CorporateComplianceAuditRequestParamsAuditScope) IsKnown() bool {
	switch r {
	case CorporateComplianceAuditRequestParamsAuditScopeAllTransactions, CorporateComplianceAuditRequestParamsAuditScopeCorporateCards, CorporateComplianceAuditRequestParamsAuditScopePayments:
		return true
	}
	return false
}
