...
type SimulationResponseRecommendation struct {
	// A machine-readable trigger for a follow-up action.
...
const (
	...
	AIOracleSimulateRunAdvancedParamsScenariosEventsTypeIncomeChange   AIOracleSimulateRunAdvancedParamsScenariosEventsType = "income_change"
)

func (r AIOracleSimulateRunAdvancedParamsScenariosEventsType) IsKnown() bool {
	switch r {
	case AIOracleSimulateRunAdvancedParamsScenariosEventsTypeJobLoss, AIOracleSimulateRunAdvancedParamsScenariosEventsTypeMarketDownturn, AIOracleSimulateRunAdvancedParamsScenariosEventsTypeLargePurchase, AIOracleSimulateRunAdvancedParamsScenariosEventsTypeIncomeChange:
		return true
	}
	return false
}
...
type AIOracleSimulateRunStandardParams struct {
	// A natural language prompt describing the scenario.
	Prompt param.Field[string] `json:"prompt,required"`
	// Structured parameters for the simulation.
