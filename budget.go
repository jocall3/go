...
type Budget struct {
	...
	// Percentage threshold to trigger an alert.
...
func (r BudgetStatus) IsKnown() bool {
	switch r {
	case BudgetStatusActive, BudgetStatusCompleted, BudgetStatusArchived:
		return true
	}
	return false
}
...
func (r BudgetNewParamsPeriod) IsKnown() bool {
	switch r {
	case BudgetNewParamsPeriodWeekly, BudgetNewParamsPeriodMonthly, BudgetNewParamsPeriodYearly:
		return true
	}
	return false
}
